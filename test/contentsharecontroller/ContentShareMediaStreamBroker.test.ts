...
describe('ContentShareMediaStreamBroker', () => {
  ...
  describe('acquireAudioInputStream', () => {
    ...
    beforeEach(() => {
      ...
      synthesizeAudioDevice = sinon.stub(DefaultDeviceController,'synthesizeAudioDevice').callsFake(() => {
  ...
  describe('bindToAudioVideoController', () => {
    it('not supported', () => {
      expect(() => {contentShareMediaStreamBroker.bindToAudioVideoController(null)}).to.throw('unsupported');
    })
  });
});